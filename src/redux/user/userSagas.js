...
import { auth, getCurrentUser, handleUserProfile, provider } from "../../firebase/functions";
import { setUserData, signInSuccess, signOutUserSuccess, userError } from "./user.action";
...
export default function* userSagas(){
    yield all([
        call(onGogleSignInStart), call(onCheckUserSession),
        call(onSignOutUserStart), call(onEmailSignUp),
        call(onEmailLogin), call(onFetchUserDataStart)
    ])
}